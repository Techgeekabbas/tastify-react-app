        ...
        <>
            <div className="flex max-w-[1240px] mx-auto items-center p-4 justify-between">
                <div className="cursor-pointer">
                    <h1 className='font-bold text-3xl sm:text-4xl lg:text-4xl text-orange-400 '>Tastify</h1>
                </div>
                <div className='flex'>
                <div className="flex justify-center bg-gray-200 h-10 rounded-md sm:pl-2 sm:w-[400px] lg:w-[400px] items-center">
                    ...
                    <div className="login">
                        <button className='bg-orange-500 text-white px-5 py-1 ml-2 h-10 w-[100px] rounded-md'>Login</button>
                    </div>
                </div>
            </div>
        </>
